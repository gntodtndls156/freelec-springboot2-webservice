...
public class PostsApiControllerTest {
    ...
    public void Posts_register() throws Exception {
        ...
        PostsSaveRequiestDto requiestDto = PostsSaveRequiestDto.builder().title(title).content(content).author("author").build();

        String url = "http://localhost:" + port + "/api/v1/posts";

        // when
        ResponseEntity<Long> responseEntity = restTemplate.postForEntity(url, requiestDto, Long.class);
